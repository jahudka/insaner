...
export type ContextFactory<Context extends OperationContext> = (
  request: Request<HttpRequest, unknown>,
) => Promise<Context> | Context;

export type GraphQLHandlerOptions<
  Context extends OperationContext = any,
  Root extends object = any,
> = {
...
export type TypedExecutionArgs<
  Context extends OperationContext = any,
  Root extends object = any,
> = Omit<ExecutionArgs, 'rootValue' | 'contextValue'> & {
  rootValue?: Root;
