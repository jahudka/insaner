...
export class TextResponse extends HttpResponse {
  ...
  constructor(content: string, headers?: Record<string, string | string[]>, cookies?: Cookie[]);
  constructor(
    status: number,
    content: string,
  ...
  constructor(a0: any, b0?: any, c0?: any, d0?: any, e0?: any) {
    const [status, content, c1, d1, e1] =
      typeof a0 === 'number' ? [a0, b0, c0, d0, e0] : [200, a0, b0, c0, d0];
    const [type, headers, cookies] = typeof c1 === 'string' ? [c1, d1, e1] : ['text/plain', c1, d1];
